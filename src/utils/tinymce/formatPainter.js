...
!(function (l) {
  ...
  var e,
      ...
      return (
        ...
        -1 ===
          (function (e, r) {
            ...
            b([(n = e).majorVersion, n.minorVersion].join('.').split('.').slice(0, 3).join('.')),
            b(r)
          )
      )
      var n
    ...
    re = function (e, r, n) {
      !(function (e, r, n) {
        if (!(C(n) || L(n) || P(n)))
          throw (
            (l.console.error('Invalid call to Attr.set. Key ', r, ':: Value ', n, ':: Element ', e),
  ...
  var de,
    ...
    Ue = [
      ...
      { name: 'OSX', search: Me('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
