...
<template>
  ...
  >
    <div class="leave-dialog-main">
      ...
      <p v-else-if="leaveData.count" class="desc text14 icon-color mb16">
        {{ leaveData.desc }}
      </p>
      <BBaseSelect
        v-if="showSelect"
      ...
      <div v-if="leaveData.count || isTransfer" class="agree text14 minor-color mt4 el-checkobx-label-color">
